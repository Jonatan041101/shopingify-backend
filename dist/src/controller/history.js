...
exports.getHistorysCategorysProduct = exports.addProduct = exports.updateHistory = exports.getHistoryPending = exports.createHistory = exports.getHistorys = void 0;
...
const getHistorys = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const createHistory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!history)
            throw new Error('Error en la creacion de la lista.');
        const products = (0, parseProductListToHistory_1.parseProductsHistory)(productsList, history.id);
        const createdExit = yield (0, productListQuery_1.createManyProductListQuery)(products);
        if (!createdExit) {
            throw new Error(`Error en la creacion de los productos de la lista ${nameList}`);
        }
        const getHistoryCreated = yield (0, historyQuery_1.getProductsHistoryCreated)(history.id);
...
const getHistoryPending = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const historyPending = yield (0, historyQuery_1.searchHistoryPending)();
        if (!historyPending)
            throw new Error('No hay una lista pendiente');
...
const updateHistory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const history = yield (0, historyQuery_1.updateHistoryQuery)(historyId, status);
        res.json({ history });
    }
    catch (error) {
        console.log({ error });
...
const addProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const searchProduct = yield (0, productListQuery_1.searchProductListQuery)(historyId, productId);
        if (!searchProduct) {
            const productList = yield (0, productListQuery_1.createdProductListQuery)(historyId, productId);
            if (!productList)
        ...
        const productList = yield (0, productListQuery_1.updateProductListCountQuery)(searchProduct.id, 1);
        if (!productList)
            throw new Error((0, productList_1.errorModelsId)(productId));
        return res.json({
...
const getHistorysCategorysProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        historys.forEach((product) => {
            product.product.forEach((productName) => {
                const existProduct = productsStats.find((prod) => prod.name === productName.product.name);
                const existCategory = categoryStats.find((category) => category.name === productName.product.category.name);
                if (!existCategory) {
                    const newCategory = {
                        count: 1,

...
const updateProductList = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      productListQuery_1.updateProductListCountQuery)(id, count);
...
const deleteProductList = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.body;
    try {
      (0, history_1.validateString)(id);
      const productToDelete = yield (0,
      productListQuery_1.searchProductListWithIDQuery)(id);
      if (!productToDelete)
        throw new Error(`El producto con id  ${id} no exite`);
      const productList = yield (0, productListQuery_1.deleteProductListQuery)(
        id
      );
      if (!productList) throw new Error(`El producto con id  ${id} no exite`);
      return res.json({
        message: `El producto con id ${
          productToDelete === null || productToDelete === void 0
            ? void 0
            : productToDelete.product.name
        } se a eliminado de la lista.`,
      });
    } catch (error) {
      console.log({ error });
      (0, errors_1.errorQuery)(res, error);
